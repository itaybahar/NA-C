...
namespace API_Project.Migrations
{
    ...
    [Migration("20250410175504_FixUserRoleAssignments")]
    partial class FixUserRoleAssignments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain_Project.Models.UserRoleAssignment", b =>
                {
                    b.HasOne("Domain_Project.Models.UserRole", null)
                        .WithMany()
                        .HasForeignKey("RoleID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain_Project.Models.User", null)
                        .WithMany()
